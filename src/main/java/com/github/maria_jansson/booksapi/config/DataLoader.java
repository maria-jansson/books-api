...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(BookRepository bookRepo, AuthorRepository authorRepo, CategoryRepository categoryRepo) {
    ...
    private List<Category> getOrCreateCategories(String categoryRaw, Map<String, Category> categoryMap) {
